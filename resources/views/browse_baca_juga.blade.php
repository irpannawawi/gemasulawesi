                        ...
                        <tbody>
                            ...
                            @foreach ($posts as $post)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-default btn-sm" onclick="sendBacaJuga('{{ $post->title }}', '{{$_SERVER['SERVER_NAME']}}/id/{{str_replace(' ','%20',$post->rubrik->rubrik_name)}}/{{$post->post_id}}/{{$post->slug}}')">Choose</button>
                                    </td>
                                </tr>
                            @endforeach
