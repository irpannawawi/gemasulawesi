<x-app-layout>
    ...
    <div class="card">
        <div class="card-header">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <a class="btn border btn-xs btn-danger mx-3 float-right" onclick="return confirm('Are you sure?')"
            href="{{ route('editorial.emptyTrash') }}"><i class="fa fa-trash"></i> Empty Trash</a>
        ...
        <div class="card-body table-responsive">
            <table class="table table-sm"><thead class="text-center">
                @php
