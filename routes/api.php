...
Route::get('articles', function (Request $request) {
    $articles = Posts::where('status', 'published')
        // ->offset($request->start)
        // ->limit($request->length)
        // ->select('post_id', 'title', 'published_at')// Sesuaikan dengan nama kolom yang sesuai dengan tabel posts
        ->with('rubrik', 'author', 'editor') // Mengambil relasi rubrik
        ->whereHas('rubrik'); // Memeriksa keberadaan relasi rubrik
